...
public class InfoServiceImpl implements InfoService{
	...
	public Map<String, Object> getInfoById(String id) {
		...
		if(null!=file){
			file.put("content", file.get("content").toString().replaceAll("http://localhost:80", GlobalConstant.SYS_MAP.get(GlobalConstant.FILE_WEB_SERVER)));
		}
	...
	public boolean setRecommend(String id) {
		infoMapper.removeRecommend();
		return infoMapper.setRecommend(id);
	}
